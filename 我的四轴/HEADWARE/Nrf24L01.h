...
#define TX_ADR_WIDTH    5 	 	//数据包长度
#define RX_ADR_WIDTH    5   	

#define NRF_DISENABLE  GPIOA->BSRR = GPIO_Pin_3;//cs片选
#define NRF_ENABLE  GPIOA->BRR = GPIO_Pin_3;
#define NRF_CE_H  GPIOA->BSRR = GPIO_Pin_2;//ce使能
#define NRF_CE_L  GPIOA->BRR = GPIO_Pin_2;
